...
<h2>[ 상품 문의 ]</h2>
	<div id="sk2">
		<input type="text" id="contents2" placeholder=" 문의하기" autofocus/>
		...
		{{#each array}}
			<div class="replyBox2" style="overflow:hidden;font-size:15px;" writer={{writer}} rn={{rn}} qid={{qid}} >
				 	<div class="replyMenu2" style="overflow:hidden;text-align:left;padding:10px;width:700px;margin:0px auto;border:1px solid lightgrey; box-shadow:0px 0px 10px lightgrey;">
						...
						<button class="btnEdit2" qid={{qid}} answer={{answer}} score={{score}} writer={{writer}} content={{content}} style="{{hidden2 writer}}float:right;padding:5px; border-radius:20px;">문의글 수정</button>
						<button class="btnAnswer2" style="{{hidden3 ans}}float:right;padding:5px; border-radius:20px;">답변 달기</button>
					</div>
					<b>{{writer}} :</b> 
					<input type="text" class="replyContent2" writer={{writer}} value="{{content}}" style="text-align:center;background:none; border:2px solid black; border-radius:0px; margin:10px;" disabled/>
					<br>
					<button class="btnEditor2" score={{score}} qid={{qid}} writer={{writer}} content={{content}} style="display:none;padding:5px;border-radius:20px;">수정하기</button>
					...
					<div class="answerBox" style="float:left;padding-left:280px;" answer={{answer}} >
						...
						<b>ㄴ 담당자 : </b> 
						<input type="text" class="answerContent2" writer={{writer}} value="{{answer}}" style="text-align:center;background:none; border:2px solid black; border-radius:0px; margin:10px;" disabled/>
